...
export const manifest = {
  questions: [
    ...
    {
      header: 'Workshops',
      label: `At Hack Bahamas, attendees will have an opportunity to host their own informal workshops! You bring a passion and we'll provide a room with participants. These questions are not a commitment! You can choose to change your topic or not present at any time.`,
      items: [
        {
